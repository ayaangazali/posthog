...
export interface tracingDataLogicValues {
    ...
    orderBy: TracingOrderBy // tracingFiltersLogic
    ...
    aggregationAbortController: AbortController | null
    aggregationLoading: boolean
    durationHistogramAbortController: AbortController | null
    durationHistogramData: TracingDurationHistogramData
    durationHistogramLoading: boolean
    ...
    latencyHeatmapAbortController: AbortController | null
    ...
    spanTreeAbortController: AbortController | null
    ...
    traceSpansLoadingMore: boolean
    traceSpansNextOffset: number
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface tracingDataLogicActions {
    setFeatureFlags: (
        flags: string[],
    ...
    cancelInProgressDurationHistogram: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    cancelInProgressLatencyHeatmap: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    cancelInProgressMatchingCounts: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    cancelInProgressSpanTree: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    cancelInProgressSpans: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    cancelInProgressSparkline: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    clearSpans: () => {
        value: true
    ...
    fetchDurationHistogram: () => any
    fetchDurationHistogramFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    loadTraceSpans: ({ traceId, ts }: { traceId: string; ts?: string | null }) => {
        traceId: string
        ts?: string | null
    }
    loadTraceSpansFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    setDurationHistogramAbortController: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    setHasMoreToLoad: (hasMore: boolean) => {
        hasMore: boolean
    }
    ...
    setLatencyHeatmapAbortController: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    ...
    setSpanTreeAbortController: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    setSpansAbortController: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    setSparklineAbortController: (controller: AbortController | null) => {
        controller: AbortController | null
    }
    setTracePagination: (
        hasMore: boolean,
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface tracingDataLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        sparklineData: (rawSparklineData: SparklineRow[]) => TracingSparklineData
...
export type tracingDataLogicType = MakeLogicType<
    tracingDataLogicValues,
    tracingDataLogicActions,
    TracingDataLogicProps,
    tracingDataLogicMeta
>
...
export const tracingDataLogic = kea<tracingDataLogicType>([
    ...
    actions({
        ...
        cancelInProgressLatencyHeatmap: (controller: AbortController | null) => ({ controller }),
    ...
    reducers({
        ...
        latencyHeatmapAbortController: [
            null as AbortController | null,
            { setLatencyHeatmapAbortController: (_, { controller }) => controller },
        ],
        ...
        latencyHeatmapLoading: [
            false as boolean,
            {
                fetchLatencyHeatmap: () => true,
                fetchLatencyHeatmapSuccess: () => false,
    ...
    listeners(({ actions, values }) => ({
        ...
        setChartType: ({ chartType }) => actions.handleFilterChange('chart_type', { chart_type: chartType }),
        ...
        runQuery: () => {
            ...
            // The heatmap wins the chart slot, so skip the histogram fetch it would hide.
            if (values.isDurationMode && !values.showHeatmap) {
